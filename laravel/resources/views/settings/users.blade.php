                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-secondary" onclick="editUser({{ json_encode($user) }})">
        ...
        <form method="POST" action="{{ route('settings.users.store') }}">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="create_password_confirmation" name="password_confirmation" required class="form-control">
                </div>
            </div>
