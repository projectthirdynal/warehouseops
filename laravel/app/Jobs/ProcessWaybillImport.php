...
class ProcessWaybillImport implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            // Import with ultra-fast streaming reader
            $importer = new \App\Imports\FastWaybillImport($this->uploadId, $this->batchReady);
            $totalRows = $importer->import($fullPath);

            // Row counts and status are updated inside FastWaybillImport::import
